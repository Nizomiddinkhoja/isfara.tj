...
if ($_SESSION["is_auth"]) {
    ...
    if(isset($_POST["submit"])){
        ...
        if (isset($_FILES["filename"]) && $_FILES["photo"]["error"] == 0) {
            if(move_uploaded_file($_FILES["filename"]["tmp_name"], "../../img/" . $_FILES["filename"]["name"])) {
                ...
                $dbOperation->editWhoIs($id, $file);
            }
        }
        try {
            $dbOperation->editWhoIsText($id, $title_ru, $position_ru, "ru");
            $dbOperation->editWhoIsText($id, $title_en, $position_en, "en");
            $dbOperation->editWhoIsText($id, $title_tj, $position_tj, "tj");
    ...
    $row_ru = mysqli_fetch_array($dbOperation->getWhoIsByID($id, "ru"));
    $row_tj = mysqli_fetch_array($dbOperation->getWhoIsByID($id, "tj"));
    $row_en = mysqli_fetch_array($dbOperation->getWhoIsByID($id, "en"));
    ?>
    <!DOCTYPE html>
    <html lang="en">
                                ...
                                <div class="chart" style="height:auto">
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input class="form-control" name="name_tj" value="<?=$row_tj[0]?>" placeholder="Ному насаб" type="text" required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <textarea class="form-control" name="position_tj" placeholder="Вазифа" style="height :50px" required ><?=$row_tj[1]?></textarea>
...
<!--                                                <span class="input-group-text"><i class="ni ni-email-83"></i></span>-->
<!--                                            </div>-->
<!--                                            <input class="form-control" name="name_ru" value="--><?//=$row_ru[0]?><!--" placeholder="ФИО" type="text" required>-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                    <div class="form-group mb-3">-->
<!--                                        <div class="input-group input-group-alternative">-->
...
<!--                                                <span class="input-group-text"><i class="ni ni-email-83"></i></span>-->
<!--                                            </div>-->
<!--                                            <textarea class="form-control" name="position_ru" placeholder="Должность" style="height :50px" required>--><?//=$row_ru[1]?><!--</textarea>-->
<!--                                            <!-- <input class="form-control" placeholder="Описание" type="text"> -->-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                </div>-->
...
<!--                                                <span class="input-group-text"><i class="ni ni-email-83"></i></span>-->
<!--                                            </div>-->
<!--                                            <input class="form-control" value="--><?//=$row_en[0]?><!--" name="name_en" placeholder="Full name" type="text" required>-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                    <div class="form-group mb-3">-->
<!--                                        <div class="input-group input-group-alternative">-->
...
<!--                                                <span class="input-group-text"><i class="ni ni-email-83"></i></span>-->
<!--                                            </div>-->
<!--                                            <textarea class="form-control" name="position_en" placeholder="Position" style="height :50px" required>--><?//=$row_en[1]?><!--</textarea>-->
<!--                                            <!-- <input class="form-control" placeholder="Описание" type="text"> -->-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                </div>-->
                                ...
                                <div class="card-columns">
                                    <div class="form-group mb-3">
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <a href="delete_img_who_is.php?id='.$id.'">Удалить</a><br><br>';
