...
<!--                                                <li class="sp-menu-item"><a href="category.php?id=6">Эмиграция</a></li>-->
                                        ...
                                        <li class="item- menu-deeper menu-parent"><a>Язык</a><span
                                        ...
                                        <div class="media">
                                            <div class="pull-left">
                                                <div class="sp-weather-current-temp">
                                                    ...
                                                    <a id="ms-informer-link-960f711b41d49dfcc2367201fb4ce21f" class="ms-informer-link" href="https://www.meteoservice.ru/weather/overview/isfara">Погода в Исфаре</a>
                    ...
                    <div class="sp-column ">
                        <nav class="sp-megamenu-wrapper" role="navigation">
                            <ul class="sp-megamenu-parent menu-animation-fade-up d-none d-lg-block">
                                ...
                                <li class="sp-menu-item sp-has-child"><a href="category.php?id=30">Туристы</a>
                                    <div class="sp-dropdown sp-dropdown-main sp-menu-right"
                                         style="width: 240px;">
                                        <div class="sp-dropdown-inner">
                                            <ul class="sp-dropdown-items">
