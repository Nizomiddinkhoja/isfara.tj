                                                                                        ...
                                                                                        <div class="sppb-addon sppb-addon-module">
                                                                                            <div class="sppb-addon-content">
                                                                                                ...
                                                                                                echo "<ul class=\"categories-module mod-list\" >
                                                                                                    <li>
                                                                                                        <h4>
                                                                                                            <i class=\"fa fa-user-circle\"></i> Имрӯз: $today[0]
                                                                                                        </h4>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <h4>
                                                                                                            <i class=\"fa fa-user-circle\"></i> Ҳамин ҳафта: $week[0]
                                                                                                        </h4>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <h4>
                                                                                                            <i class=\"fa fa-user-circle\"></i> Ҳамин моҳ: $month[0]
                                                                                                        </h4>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <h4>
                                                                                                            <i class=\"fa fa-user-circle\"></i> Ҳамин сол: $year[0]
                                                                                                        </h4>
                                                                                                    </li>
                                                                                                    <li>
                                                                                                        <h4>
                                                                                                            <i class=\"fa fa-user-circle\"></i> Ҳамагӣ: $all[0]
                                                                                                        </h4>
                                                                                                    </li>
                                                                                                </ul>";
                                                                                                ?>
                                                                                                                            ...
                                                                                                                            <div class="sppb-column-addons">
                                                                                                                                <div id="sppb-addon-wrapper-1574411095394"
                                                                                                                                    ...
                                                                                                                                    <div id="sppb-addon-1574411095394"
                                                                                                                                         class="clearfix ">
                                                                                                                                        <div class="sppb-addon sppb-addon-header sppb-text-left">
                                                                                                                                            <h2 class="sppb-addon-title"><a href="jamoats.php">Ҷамоатҳо</a></h2>
                                                                                                                                        </div>
