<section id="sp-bottom-top">
    <div class="container">
        <div class="container-inner">
            <div class="row">
                <div id="sp-top1" class="col-sm-1 col-md-1 col-lg-4">
                    <div class="sp-column ">
                        <div class="sp-module">
                                ...
                                <div class="icon-top-wrapper">
                                    <form method="post" class="search-form" action="search_result.php">
                                        <div class="form-group d-flex align-items-center">
                                            ...
                                            <button style="border: none; background: #ffffff; height: 90%; margin-right: 10px"
                                                    class="fa fa-search" type="submit" name="submit">
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div id="sp-logo" class="col-sm-6 col-md-6 col-lg-4 ">
                    <div class="sp-column "><a id="offcanvas-toggler" aria-label="Navigation"
                        ...
                        <div class="logo"><a href="./index.php"><img class="logo-image"
                                                                     ...
                                                                     style="DISPLAY: -webkit-inline-box; height: 120px; ">Сомонаи
                                расмии МИҲД
                                Исфара</a></div>
                    </div>
                </div>
                        ...
                        <div class="sp-module "><h3 class="sp-module-title">Меню</h3>
                            <div class="sp-module-content">
                                <ul class="menu">
                                    ...
                                    <li class="sp-menu-item sp-has-child"><a href="contact.php">Қабулгоҳи электронӣ</a>
                                </ul>
                            </div>
                        </div>
                    </div>
