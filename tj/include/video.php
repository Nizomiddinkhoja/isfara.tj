...
$result_question_ru = $dbOperation->getQuestionByID($id, 'tj');
$question_ru = mysqli_fetch_array($result_question_ru);

$result_answer_ru = $dbOperation->getAnswer($id, 'tj');
...
if(isset($_POST["submit"])) {
  //  $answer_ru1 = $_POST["answer_ru"];
    ...
    try{
        ...
        $message = "<h4 class='text-success'>Ташаккур барои чавоб!</h4>";
        $_POST="";
//        unset($_POST["submit"]);
    }catch (Exception $exception){
        $message = "<h4 class='text-danger'>Хатоги: ". $exception->getMessage()."</h4>";
    }
}
?>
