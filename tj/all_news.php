...
include("../counter.php");
    ...
    $category = mysqli_fetch_array($dbOperations->getCategoryByID($news[4], "tj"));
...
<head>
    ...
    <title>Ҳамаи хабарҳои сомонаи расмии мақомоти иҷроияи ҳокимияти давлатии шаҳри Исфара</title>
                    ...
                    <div class="row">
                        <main id="sp-component" class="col-lg-12 " role="main">
                            <div class="sp-column ">
                                ...
                                <div class="blog">
                                    <h3 class="newsberg-blog-title">Ҳамаи хабарҳо</h3>
                                                ...
                                                <div class="newsberg-article-content-leading-wrap row">
                                                    <div class="newsberg-article-content col-sm-5">
                                                        ...
                                                        <div class="article-header">
                                                            <h2>
                                                                <a href="view_news.php?id=<?=$news[0]?>&category=<?=$category[2]?>"><?=$news[1]?></a>
                                                            </h2>
                                                        </div>
                                                    ...
                                                    <div class="newsberg-article-image col-sm-7">
                                                        <a href="view_news.php?id=<?=$news[0]?>&category=<?=$category[2]?>">
